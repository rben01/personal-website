...
+
Below is an example of this kind of indentation with two equivalent styles show.
...
So if you want to use an autoformatter to format your code, and you're not writing Go, you'll need to either format your code the dumb way, submit a bug report on the auto-formatter's repo, or, preferably, submit a pull request that implements this behavior.
