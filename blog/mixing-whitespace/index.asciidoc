...
So chances are that if you want to use an autoformatter to format your code, you'll need to either format your code the dumb way, open an issue on the auto-formatter's repo, or, preferably, submit a pull request that implements this behavior.
